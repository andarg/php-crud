...
class CRUDTable
{
    ...
    static public function html($model_class_name, $create_form_html, $column_obj_arr, $filters_arr = [], $order_by = '')
    {
                ...
                CRUD.Table = {
                    ...
                    requestAjax: function (table_container_element_id, query) {
                        ...
                        $.ajax({
                           ...
                           // console.log( $(received_html).find('div[id^="tableContainer_"]') );

                            $(table_elem_selector).html($(received_html).find('.table').html());
                            $(pagination_elem_selector).html($(received_html).find('.pagination').html());
                            CRUD.Table.clickTableRow(table_container_element_id);
                        });
                    }
                };
        ...
        $table_container_element_id = 'tableContainer_' . uniqid();
        ...
        $html .= '</div>';
        $html .= "<script>CRUD.Table.init('" . $table_container_element_id . "', '" . Url::getCurrentUrl() . "');</script>";
